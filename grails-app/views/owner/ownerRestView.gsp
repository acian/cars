		...
		<dialog class="mdl-dialog">
			...
			<div class="mdl-dialog__content">
				...
				<form action="#">
					...
					<div class="mdl-textfield mdl-js-textfield">
						<input id="dni" name="dni" type="text" class="mdl-textfield__input"  pattern="-?[0-9]*(\.[0-9]+)?">
			...
			<div>
				...
				<button type="button" class="mdl-button" onclick="javascript:deleteOwner();">Delete</button>
			</div>
		</dialog>
